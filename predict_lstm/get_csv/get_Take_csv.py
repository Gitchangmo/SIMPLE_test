...
def generate_empty_hand_sequence(save_dir, num_sequences=150, frames_per_seq=120, img_width=1280):
    ...
    for seq_idx in range(num_sequences):
        ...
        for frame_idx in range(frames_per_seq): #120번 반복
            ...
            elif not moving_forward and not moving_backward: # 냉장고 내부에 위치할 때
                roi_counter+=1
                row = {
        ...
        save_path = os.path.join(save_dir, f"Take_Right_{seq_idx+1:03d}.csv")
...
# 사용법 예시
# -----------------------------
generate_empty_hand_sequence(save_dir="./lstm_csv_files/Take_Data/", num_sequences=50)
