...
def generate_empty_hand_sequence(save_dir, num_sequences=150, frames_per_seq=120, img_width=1280):
    ...
    for seq_idx in range(num_sequences):
        ...
        save_path = os.path.join(save_dir, f"Put_Left_Slow_{seq_idx+76:03d}.csv")
...
# 사용법 예시
# -----------------------------
generate_empty_hand_sequence(save_dir="./lstm_csv_files/Put_Data/", num_sequences=25)
