...
def generate_empty_hand_sequence(save_dir, num_sequences=150, frames_per_seq=120, img_width=1280):
    ...
    for seq_idx in range(num_sequences):
        ...
        y1 = random.randint(600, 650) # 150,200 // 600, 650
        box_width = 200
        box_height = 200
        roi = 832
        action_value = 0
        ...
        save_path = os.path.join(save_dir, f"Take_Right_sasun_{seq_idx+13:03d}.csv")
...
# 사용법 예시
# -----------------------------
generate_empty_hand_sequence(save_dir="./lstm_csv_files/Take_Data/", num_sequences=13)
