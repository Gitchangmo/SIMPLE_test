...
def generate_empty_hand_sequence(save_dir, num_sequences=150, frames_per_seq=120, img_width=1280):
    ...
    for seq_idx in range(num_sequences):
        ...
        y1 = random.randint(150, 200) # 150,200 // 600, 650
        box_width = 200
        box_height = 200
        roi = 832
        action_value = 0
        ...
        for frame_idx in range(frames_per_seq): #120번 반복
            ...
            if moving_forward == True:
                ...
                y_shift = random.randint(5, 20)  # -3, 15 // -3 , 20
        ...
        save_path = os.path.join(save_dir, f"Put_Right_sasun_{seq_idx+1:03d}.csv")
...
# 사용법 예시
# -----------------------------
generate_empty_hand_sequence(save_dir="./lstm_csv_files/Put_Data/", num_sequences=12)
